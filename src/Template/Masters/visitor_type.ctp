        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    <p class="caption">Add Visitor Type</p>
                </div>
            </div>
                    ...
                    <div class="col m12">
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card-panel">
                                <h4 class="header2 temp_col">Visitor Type Details</h4>
                                <div class="row">
                                    <?php echo $this->Form->create(null, ['url' => ['controller' => 'masters','action' => 'visitorType/add'], 'class' => 'col s12 right-alert']);?>
                                    <div class="row">
                                        <div class="input-field col s6">
